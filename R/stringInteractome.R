...
#' @docType data
#' @format
#' "string" is an igraph network object of 9725 nodes and 170987 edges 
#' corresponding to the STRING interactome (version 10.5).
...
#' datasets. Nucleic Acids Res., 47: D607-613. 
